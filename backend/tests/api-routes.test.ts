...
vi.mock('../src/dao-registry/index.js', () => ({
    listDaos: vi.fn(async () => ({
        factoryContractId: 'ST1TEST.dao-factory-v2-c4',
        defaultDaoId: '1',
        daos: [],
    })),
    resolveDaoContext: vi.fn(async () => ({
        ...
        contracts: {
            daoTraits: 'ST1TEST.dao-traits-v2-c4',
            core: 'ST1TEST.dao-core-v2-c4',
            proposals: 'ST1TEST.proposal-submission-v2-c4',
            voting: 'ST1TEST.proposal-voting-v2-c4',
            treasury: 'ST1TEST.treasury-v2-c4',
            treasuryActions: 'ST1TEST.treasury-actions-v2-c4',
            governanceToken: 'ST1TEST.governance-token-v2-c4',
            membership: 'ST1TEST.membership-v2-c4',
            extensionsRegistry: 'ST1TEST.extensions-registry-v2-c4',
            templateRegistry: 'ST1TEST.template-registry-v2-c4',
            factory: 'ST1TEST.dao-factory-v2-c4',
            mockProposal: 'ST1TEST.mock-proposal-v2-c4',
            testExecutor: 'ST1TEST.test-executor-v2-c4',
            proposalExecutor: 'ST1TEST.proposal-executor-v2-c4',
            timelockController: 'ST1TEST.timelock-controller-v2-c4',
            proposalCanceler: 'ST1TEST.proposal-canceler-v2-c4',
            emergencyGuardian: 'ST1TEST.emergency-guardian-v2-c4',
            governanceParams: 'ST1TEST.governance-params-v2-c4',
            votingStrategyModule: 'ST1TEST.voting-strategy-module-v2-c4',
            quorumCurve: 'ST1TEST.quorum-curve-v2-c4',
            proposalMetadata: 'ST1TEST.proposal-metadata-v2-c4',
            proposalTags: 'ST1TEST.proposal-tags-v2-c4',
            treasuryGuardrails: 'ST1TEST.treasury-guardrails-v2-c4',
            treasuryStreaming: 'ST1TEST.treasury-streaming-v2-c4',
            grantsEscrow: 'ST1TEST.grants-escrow-v2-c4',
            vestingManager: 'ST1TEST.vesting-manager-v2-c4',
            feeRebate: 'ST1TEST.fee-rebate-v2-c4',
            treasuryBudget: 'ST1TEST.treasury-budget-v2-c4',
            multisigAdapter: 'ST1TEST.multisig-adapter-v2-c4',
            automationRegistry: 'ST1TEST.automation-registry-v2-c4',
            addressBook: 'ST1TEST.address-book-v2-c4',
        },
        daoId: '1',
        name: 'Test DAO',
    })),
