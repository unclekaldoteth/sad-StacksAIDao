...
vi.mock('../src/dao-registry/index.js', () => ({
    listDaos: vi.fn(async () => ({
        factoryContractId: 'ST1TEST.dao-factory-v2',
        defaultDaoId: '1',
        daos: [],
    })),
    resolveDaoContext: vi.fn(async () => ({
        ...
        contracts: {
            ...
            treasury: 'ST1TEST.treasury-v2',
            treasuryActions: 'ST1TEST.treasury-actions-v2',
            governanceToken: 'ST1TEST.governance-token-v2',
            membership: 'ST1TEST.membership-v2',
