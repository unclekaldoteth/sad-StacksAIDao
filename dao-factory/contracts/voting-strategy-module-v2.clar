...
(define-read-only (evaluate (proposal-id uint))
  {
    ...
    quorum-reached: (contract-call? .proposal-voting-v2 is-quorum-reached proposal-id),
    approval-bps: (contract-call? .proposal-voting-v2 get-approval-percentage proposal-id),
